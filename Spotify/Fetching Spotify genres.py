...
for i in range(0, len(list2)):
    if i not in list2:
        with open('artist_genres_folk.csv','a', encoding='utf-8') as csvfile:
...
Name_List=['Genre','Frequency']
df = pd.read_csv("artist_genres_folk.csv", names=Name_List)

pd.DataFrame(df).to_excel('artist_genres_folk.xlsx')